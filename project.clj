(defproject exam-countdown "0.1.0-SNAPSHOT"
  ...
  :ring {:handler exam-countdown.handler/app
         :uberwar-name "exam-countdown.war"}

  :min-lein-version "2.5.0"

  :uberjar-name "exam-countdown.jar"

  :main exam-countdown.server
  ...
  :profiles {:dev {:repl-options {:init-ns exam-countdown.dev
